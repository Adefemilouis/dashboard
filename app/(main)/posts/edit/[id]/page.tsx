...
const PostEditPage = ({ params }: PostEditPageProps) => {
    ...
    const handleSubmit = (data: z.infer<typeof formSchema>) => {
        toast({
            title: 'Post has been updated sucessfully',
  ...
  render={({ field }) => (
    <FormItem>
      ...
      <FormControl>
        <Input className='bg-slate-100 dark:bg-slate-500 border-0 focus-visible:ring-0 text-black dark:text-white focus-visible:ring-off' placeholder="Enter Title" {...field} />
      </FormControl>
      <FormMessage />
    </FormItem>
  )}
/>
  ...
  render={({ field }) => (
    <FormItem>
      ...
      <FormControl>
        <Textarea className='bg-slate-100 dark:bg-slate-500 border-0 focus-visible:ring-0 text-black dark:text-white focus-visible:ring-off' placeholder="Enter Title" {...field} />
      </FormControl>
      <FormMessage />
    </FormItem>
  )}
